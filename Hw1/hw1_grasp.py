...
class RoboHandler:
  ...
  def openrave_init(self):
    ...
    ### Changing the Collision Checker to pqp
  ...
  def order_grasps(self):
    ...
    # Define Gains
    A = 50  # Volume Score Gain
    B = 35   # Isometry Score Gain
    C = 15   # Minimum SVD Score Gain
  ...
  def eval_grasp(self, grasp):
    with self.robot:
      ...
      try:
        ...
        vol_score = rank*rank*np.sqrt(np.linalg.det(pro)) # Volume Score
        ...
        iso_score = sigma_min/sigma_max # Isometry Score
          
        sig_min_score = sigma_min # Minimum SVD Score
